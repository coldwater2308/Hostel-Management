...
import { Backdrop, Button, Fade, IconButton, Modal, Snackbar, StepButton, tableBodyClasses, TextField, Typography } from "@mui/material";
...
<span>260 Votes</span> 
    ...
    <IconButton >
    <Button
    class="add-complaint" onClick={handleOpen}> <Add/>
    </Button>
